...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9836435852264038192)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836436145731038192)
,p_page_template_id=>wwv_flow_imp.id(9836435852264038192)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836436461413038192)
,p_page_template_id=>wwv_flow_imp.id(9836435852264038192)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836436759217038192)
,p_page_template_id=>wwv_flow_imp.id(9836435852264038192)
