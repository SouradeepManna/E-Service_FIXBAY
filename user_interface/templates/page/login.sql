...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9836446436981038197)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836446714116038198)
,p_page_template_id=>wwv_flow_imp.id(9836446436981038197)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836447048087038198)
,p_page_template_id=>wwv_flow_imp.id(9836446436981038197)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836447349038038198)
,p_page_template_id=>wwv_flow_imp.id(9836446436981038197)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836447676757038198)
,p_page_template_id=>wwv_flow_imp.id(9836446436981038197)
,p_name=>'Body Footer'
