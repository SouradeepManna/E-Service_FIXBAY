...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9836471711496038209)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836472066751038209)
,p_plug_template_id=>wwv_flow_imp.id(9836471711496038209)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836472360188038209)
,p_plug_template_id=>wwv_flow_imp.id(9836471711496038209)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836472679285038209)
,p_plug_template_id=>wwv_flow_imp.id(9836471711496038209)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836472925742038209)
,p_plug_template_id=>wwv_flow_imp.id(9836471711496038209)
,p_name=>'Sub Regions'
