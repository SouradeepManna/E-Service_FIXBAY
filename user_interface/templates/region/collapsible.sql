...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9836490643530038217)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836490973958038217)
,p_plug_template_id=>wwv_flow_imp.id(9836490643530038217)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836491284520038217)
,p_plug_template_id=>wwv_flow_imp.id(9836490643530038217)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836491500879038217)
,p_plug_template_id=>wwv_flow_imp.id(9836490643530038217)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836491809643038217)
,p_plug_template_id=>wwv_flow_imp.id(9836490643530038217)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836492127106038217)
,p_plug_template_id=>wwv_flow_imp.id(9836490643530038217)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836492408028038218)
,p_plug_template_id=>wwv_flow_imp.id(9836490643530038217)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836492761451038218)
,p_plug_template_id=>wwv_flow_imp.id(9836490643530038217)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836493028536038218)
,p_plug_template_id=>wwv_flow_imp.id(9836490643530038217)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836493383700038218)
,p_plug_template_id=>wwv_flow_imp.id(9836490643530038217)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836493617225038218)
,p_plug_template_id=>wwv_flow_imp.id(9836490643530038217)
,p_name=>'Sub Regions'
