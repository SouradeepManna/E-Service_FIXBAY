...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9836473126276038209)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836473469750038210)
,p_plug_template_id=>wwv_flow_imp.id(9836473126276038209)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836473780734038210)
,p_plug_template_id=>wwv_flow_imp.id(9836473126276038209)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836474019579038210)
,p_plug_template_id=>wwv_flow_imp.id(9836473126276038209)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836474385207038210)
,p_plug_template_id=>wwv_flow_imp.id(9836473126276038209)
,p_name=>'Sub Regions'
