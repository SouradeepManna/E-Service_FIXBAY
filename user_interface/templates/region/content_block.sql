...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9836500402113038221)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836500778722038221)
,p_plug_template_id=>wwv_flow_imp.id(9836500402113038221)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836501093704038221)
,p_plug_template_id=>wwv_flow_imp.id(9836500402113038221)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836501373539038221)
,p_plug_template_id=>wwv_flow_imp.id(9836500402113038221)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836501671095038222)
,p_plug_template_id=>wwv_flow_imp.id(9836500402113038221)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836501936119038222)
,p_plug_template_id=>wwv_flow_imp.id(9836500402113038221)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836502288977038222)
,p_plug_template_id=>wwv_flow_imp.id(9836500402113038221)
,p_name=>'Sub Regions'
