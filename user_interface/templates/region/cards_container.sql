...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9836478848167038212)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836479197327038212)
,p_plug_template_id=>wwv_flow_imp.id(9836478848167038212)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836479436008038212)
,p_plug_template_id=>wwv_flow_imp.id(9836478848167038212)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9836479781518038212)
,p_plug_template_id=>wwv_flow_imp.id(9836478848167038212)
,p_name=>'Sub Regions'
